...
### 75. terminal-signals-forwarded-to-sandbox
...
- Terminal signals (resize, Ctrl-C) reach the sandboxed process despite `--new-session` (`terminal-signals-forwarded-to-sandbox`)
